            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="signupForm" method="post" action="/index.php/Admin/Article/add" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">标题：</label>
                                <div class="col-sm-4">
									<select class="select1" name="sre"><option value="0">请选择出处</option>
										<?php foreach($sre_list as $v): ?>
										<option value="<?php echo $v['sre_id']?>"><?php echo '---',$v['sre_name'],'---'?></option>
										<?php endforeach; ?>
									 </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control m-b" name="pid">
										...
										<option value="<?php echo $v['cat_id']?>"><?php echo str_repeat('--',$v['deep']*2),$v['cat_name']?></option>
										<?php endforeach;?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea class="form-control" name="excerpt" cols="" rows="8" class="valid"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">发布时间：</label>
                                <div class="col-sm-4">
									<input name="time" type="text" readonly="readonly" class="form-control" value="<?php echo date('Y-m-d H:i:s')?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <!--<div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control m-b" name="pid">
										...
										<?php foreach($label_list as $v):?>
										<option value="<?php echo $v['label_id']?>"><?php echo $v['label_name']?></option>
										<?php endforeach;?>
                                    </select>
                                </div>
                            </div>-->
                            <div class="form-group">
                                ...
                                <div class="col-sm-4" style="padding-top:7px;">
                                    <input type="radio"  checked="" value="0" id="display" name="display" class="valid">显示
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio"  value="1" id="display" name="display" class="valid">不显示
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">是否允许评论：</label>
                                <div class="col-sm-4" style="padding-top:7px;">
                                    <input type="radio"  checked="" value="0" id="discuss" name="discuss" class="valid">允许
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio"  value="1" id="discuss" name="discuss" class="valid">不允许
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">是否置顶：</label>
                                <div class="col-sm-4" style="padding-top:7px;"> <input type="radio" value="0" id="top" name="top" class="valid">置顶
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio"  value="1" id="top" name="top" checked="" class="valid">不置顶
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-8 col-sm-offset-3">
                                    <button class="btn btn-primary" type="submit">马上发布</button>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
