...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="">
                            <a href="/index.php/Admin/Authority/add" class="btn btn-primary ">添加权限</a>
                        </div>
                     <!--   <div class="row">
                            <div class="col-sm-6">
                        ...
                        <table class="table table-striped table-bordered table-hover " id="editable">
                            ...
                            <?php foreach($list as $v):?>
                                <tr class="gradeA">
                                    <td><?php echo $v['authority_id']?></td>
                                    <td><?php echo str_repeat('--',$v['deep']*4),$v['authority_name']?></td>
                                    ...
                                    <td>
										<a class="btn btn-white " href="/index.php/Admin/Authority/edit/id/<?php echo $v['authority_id']?>"><i class="fa"></i>修改</a>
										<a class="btn btn-white " href="/index.php/Admin/Authority/del/id/<?php echo $v['authority_id']?>" onclick="if(confirm('确定删除！')==false)return false;"><i class="fa"></i>删除</a>
                                    </td>
                                </tr>
                            <?php endforeach;?>
                            <!--data_table end-->
    ...
    <script>
		...
		function ajax(page_id,btn_class){
				...
				$.post("/index.php/Admin/Authority/index?v=4.0",{id:page_id},function(data){
					$('#content').html("");     //清空内容列表
					...
					$.each(list,function(i,item){
						$("#content").append(
                               "<tr class='gradeA'>"
                                    ...
                                    +"<td>"
										+'<a class="btn btn-white" href="/index.php/Admin/Authority/edit/id/'+item.authority_id+'"><i class="fa"></i>修改</a>'
										+'<a class="btn btn-white" href="/index.php/Admin/Authority/del/id/'+item.authority_id+'"><i class="fa"></i>删除</a>'
                                    +"</td>"
                               +"</tr>"
								);
					});
