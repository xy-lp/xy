                                ...
                                <?php if(is_array($article)): foreach($article as $key=>$item): ?><div class="panel panel-default">
                                        <div class="panel-heading" onclick="location.href='/index.php/Admin/Article/look/id/<?php echo ($item["article_id"]); ?>'">
                                            <h5 class="panel-title">
                                                <a  href="javascript:;"><?php echo ($item["title"]); ?><code class="pull-right"><?php echo ($item["add_time"]); ?></code></a>
                                            </h5>
                                        </div>
                              ...
                              <!--  <div class="panel panel-default">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="v301" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            &lt;!&ndash;<p>自H+ v3.0版发布后，又陆续发布了7个小版本，修复了一些兼容性问题，但是没有对外发布，更新日志略过……</p>&ndash;&gt;
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default">
