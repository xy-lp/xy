                        ...
                        <div class="panel-body">
                            <div class="panel-group" id="message">
                                <?php if(is_array($message)): foreach($message as $key=>$item): ?><div class="panel panel-default">
                                        <div class="panel-heading" onclick="location.href='/index.php/Admin/Message/details/id/<?php echo ($item["message_id"]); ?>'">
                                            <h5 class="panel-title">
                                                <a  href="javascript:;"><?php echo ($item["message_content"]); ?><code class="pull-right"><?PHP echo date('Y-m-d',$item['message_time'])?></code></a>
                                            </h5>
                                        </div>
