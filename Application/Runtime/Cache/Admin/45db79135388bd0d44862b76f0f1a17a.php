...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="">
                            <a href="/index.php/Admin/Category/add" class="btn btn-primary ">添加类型</a>
                        </div>
                       <!-- <div class="row">
                            <div class="col-sm-6">
                        ...
                        <table class="table table-striped table-bordered table-hover " id="editable">
                            ...
                            <?php foreach($list as $v):?>
                                <tr class="gradeA">
                                    ...
                                    <td><?php echo str_repeat('--',$v['deep']*4),$v['cat_name']?></td>
                                    <td><?php echo $v['cat_desc']?></td>
                                    <td><?php echo $v['url']?></td>
                                    <td>
                                        <img alt="" src="/Public/default/admin/img/<?php echo empty($v['is_show'])?'yes':'no';?>.gif"/>
                                    </td>
                                    <td><?php echo $v['sort_order']?></td>
                                    <td>
										<!--<a class="btn btn-white " href="/index.php/Admin/label/index/id/<?php echo $v['cat_id']?>"><i class="fa"></i>标签</a>-->
										<a class="btn btn-white " href="/index.php/Admin/Category/edit/id/<?php echo $v['cat_id']?>"><i class="fa"></i>修改</a>
										<a class="btn btn-white " href="/index.php/Admin/Category/del/id/<?php echo $v['cat_id']?>" onclick="if(confirm('确定删除！')==false)return false;"><i class="fa"></i>删除</a>
                                    </td>
                                </tr>
                            <?php endforeach;?>
                            <!--data_table end-->
    ...
    <script>
		...
		function ajax(page_id,btn_class){
				...
				$.post("/index.php/Admin/Category/index?v=4.0",{id:page_id},function(data){
					$('#content').html("");     //清空内容列表
					...
					$.each(list,function(i,item){
						$("#content").append(
                               "<tr class='gradeA'>"
                                    ...
                                    +"<td>"
										+'<a class="btn btn-white" href="/index.php/Admin/Category/edit/id/'+item.cat_id+'"><i class="fa"></i>修改</a>'
										+'<a class="btn btn-white" href="/index.php/Admin/Category/del/id/'+item.cat_id+'"><i class="fa"></i>删除</a>'
                                    +"</td>"
                               +"</tr>"
								);
					});
