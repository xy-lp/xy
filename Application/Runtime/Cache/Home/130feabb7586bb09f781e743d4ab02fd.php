...
<div class="article">
    <div class="blogs">
        ...
        <div class="index_about">
            ...
            <p class="box_c"><span class="d_time"><?PHP echo date('Y-m-d',$info['add_time'])?></span><span>编辑：<a href='mailto:dancesmiling@qq.com'><?php echo ($info["author"]); ?></a></span><span>阅读(<?php echo ($info["hits"]); ?>)<!--（<script src=%22-classid=8&id=740&addclick=1.js%22 tppabs="http://www.yangqq.com/e/public/ViewClick/?classid=8&id=740&addclick=1"></script>）--></span></p>
            <ul class="infos"> <?php echo htmlspecialchars_decode($info['content'])?>
           ...
           --> </ul>
            <div class="keybq">
                <p><span>关键字词:</span><?php echo ($info["title"]); ?></p>
            </div>
