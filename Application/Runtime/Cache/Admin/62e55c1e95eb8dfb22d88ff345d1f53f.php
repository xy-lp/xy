                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="J_menuItem" href="/index.php/Admin/User/user_info">个人资料</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="/index.php/Admin/User/album">My 相册</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="/index.php/Admin/Message/index">留言列表</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="/index.php/Admin/User/modify_pwd">修改密码</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="/index.php/Admin/Article/recycle">文章回收站</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="/index.php/Admin/Label/index">标签列表</a>
                            </li>
                        </ul>
                    </li>
                                ...
                                <li class="m-t-xs">
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="/Public/default/admin/img/a7.jpg">
                                        </a>
                    ...
                    <div id="tab-2" class="tab-pane">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/Public/default/admin/img/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/Public/default/admin/img/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/Public/default/admin/img/a3.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/Public/default/admin/img/a4.jpg">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/Public/default/admin/img/a8.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/Public/default/admin/img/a7.jpg">
                                    </div>
                                    <div class="media-body">
