...
<body class="gray-bg">
                        ...
                        <table class="table table-striped table-bordered table-hover " id="editable">
                            ...
                            <?php foreach($list as $v):?>
                                <tr class="gradeA">
                                    ...
                                    <td><?php echo long2ip($v['visitor_ip'])?></td>
                                    <td>
										<a class="btn btn-white " href="/index.php/Admin/Message/details/id/<?php echo $v['message_id']?>"><i class="fa"></i>查看</a>
										<a class="btn btn-white " href="/index.php/Admin/Message/del/id/<?php echo $v['message_id']?>" onclick="if(confirm('确定删除！')==false)return false;"><i class="fa"></i>删除</a>
                                    </td>
                                </tr>
                            <?php endforeach;?>
                            <!--data_table end-->
    ...
    <script>
		...
		function ajax(page_id,btn_class){
				...
				$.post("/index.php/Admin/Message/index?v=4.0",{id:page_id},function(data){
					$('#content').html("");     //清空内容列表
					...
					$.each(list,function(i,item){
						$("#content").append(
                               "<tr class='gradeA'>"
                                    ...
                                    +"<td>"
										+'<a class="btn btn-white" href="/index.php/Admin/Message/details/id/'+item.message_id+'"><i class="fa"></i>查看</a>'
										+'<a class="btn btn-white" href="/index.php/Admin/Message/del/id/'+item.message_id+'"><i class="fa" onclick="if(confirm("+确定删除！+")==false)return false;"></i>删除</a>'
                                    +"</td>"
                               +"</tr>"
								);
					});
