            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="signupForm" method="post" action="/index.php/Admin/User/edit/id/6">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">用户名：</label>
                                <div class="col-sm-4">
                                    <input id="name" name="name" class="form-control" type="text" value="<?php echo $info['user_name']?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 不填则为原密码</span>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control m-b" name="pid">
										...
										<option value="<?php echo $v['role_id']?>" <?php if($info['user_role'] == $v['role_id']) echo 'selected="selected"'?>><?php echo $v['role_name']?></option>
										<?php endforeach;?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4" style="padding-top:7px;">
                                    <input type="radio"  checked="" value="0" name="display" class="valid" <?php if($info['status']==0) echo 'checked="checked"'?>>正常
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio"  value="1" name="display" class="valid" <?php if($info['status']==1) echo 'checked="checked"'?>>停用
                                </div>
                            </div>
                            <div class="form-group">
