        ...
        <div class="topblog">
            ...
            <ul>
                <?php foreach($top_article as $v):?>
                    <li><a href="/"><?php echo $v['title']?><span><?php echo mb_substr($v['excerpt'],0,25),'...'?></span></a></li>
                <?php endforeach;?>
            </ul>
        </div>
        <div class="bloglist">
 ...
 $color_array=['ab','sy','js','msh','xc','ly']; foreach($top_list as $k => $v): ?>
        ...
        <ul class="news">
            <?php foreach($cat_list as $cv):?>
                <li><a href="/"><?php echo $cv['cat_name'],'(',$cv['num'],')';?></a></li>
            <?php endforeach;?>
...
<div id="copright">Design by <a href="/admin/login/login">yuegege</a></div>
</body>
</html>