...
<div class="article">
    <div class="content">
        <div class="topblog">
            ...
            <ul>
                <?php foreach($top_article as $v):?>
                    <li><a href="/index.php/Home/Article/detail?id=<?php echo $v['article_id']?>"><?php echo $v['title']?><span><?php echo mb_substr($v['excerpt'],0,25),'...'?></span></a></li>
                <?php endforeach;?>
            </ul>
        </div>
        <div class="bloglist">
            ...
            <ul>
                ...
                <span style="width:72%;float: right">
                    ...
                    <a title="月哥哥国际后援会" href="/index.php/Home/Article/detail?id=<?php echo $v1['article_id']?>"  class="readmore">阅读全文>></a>
                </span></figure>

                <p class="dateview"><span><?php echo date("Y-m-d",$v1['add_time'])?></span><span>作者：<?php echo $v1['author']?></span><span>个人博客：[<a href="javascript:;"><?php echo $v1['cat_name']?></a>]</span></p>
            </ul>
            <?php endforeach;?>
            <!--article end-->
            <!--article begin-->
    ...
    <aside class="navsidebar">
        <nav>
            <ul>
                <?php
 $color_array=['ab','sy','js','msh','xc','ly']; foreach($top_list as $k => $v): ?>
                <li class="<?php echo $color_array[$k]?>"><a href="<?php echo $v['url']?>"><?php echo $v['cat_name']?></a></li>
                <?php endforeach;?>
        ...
        <ul class="news">
            <?php foreach($cat_list as $cv):?>
                <li><a href="javascript:;"><?php echo $cv['cat_name'],'(',$cv['num'],')';?></a></li>
            <?php endforeach;?>
...
<div id="copright">Design by <a href="/index.php/admin/login/login">yuegege</a></div>
</body>
</html>