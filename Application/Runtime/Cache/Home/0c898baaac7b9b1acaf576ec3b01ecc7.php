...
<div class="article">
    <div class="content">
        <div class="topblog">
            ...
            <ul>
                <?php foreach($hit_list as $v):?>
                    <li><a href="/"><?php echo $v['title']?><span><?php echo mb_substr($v['excerpt'],0,20),'...'?></span></a></li>
                <?php endforeach;?>
                <li><a href="/">细说PHP<span>PHP，一个嵌套的缩写名称，是英文...</span></a></li>
                <li><a href="/">6月毕业生<span>也许长大是青春必经的溃烂...</span></a></li>
                <li><a href="/">感恩生活<span></span></a></li>
            </ul>
        </div>
        <div class="bloglist">
            <!--article begin-->
            ...
            <ul>
                ...
                <figure><img src="/Public/default/home/upload/article/2015-04-10/7d49c3bc8c69c01ece56611f5a7148be.png" />
                <span style="width:72%;float: right">
                    <p><?php echo mb_substr($v1['excerpt'],0,50),'...'?></span></p>
    ...
    <aside class="navsidebar">
        <nav>
            <ul>
                <li class="ab"><a href="#" >你看我</a></li>
                <li class="sy"><a href="#">碎碎念</a></li>
                <li class="js"><a href="#">程序猿</a></li>
        ...
        <div class="slide">
            ...
            <script language='javascript'>
                ...
                var texts = "";
                //这里设置调用标记
                linkarr[1] = "http://www.yuegege.com";
                picarr[1]  = "/Public/default/home/images/01.jpg";
                textarr[1] = "Yuegege 个人相册";
                linkarr[2] = "http://www.yuegege.com";
                picarr[2]  = "/Public/default/home/images/02.jpg";
                textarr[2] = " Yuegege 个人相册";
                linkarr[3] = "http://www.yuegege.com";
                picarr[3]  = "/Public/default/home/images/03.jpg";
                textarr[3] = "Yuegege 个人相册";
                linkarr[4] = "http://www.yuegege.com";
                picarr[4]  = "/Public/default/home/images/04.jpg";
                textarr[4] = "Yuegege 个人相册";
                linkarr[5] = "http://www.yuegege.com";
                picarr[5]  = "/Public/default/home/images/02.jpg";
                textarr[5] = "Yuegege 个人相册";
        ...
        <div class="vcard">
            <p class="fn">姓名：月哥哥</p>
            <p class="nickname">网名：yuegege</p>
            <p class="url">主页：<a href="http://www.yuegege.com" target="_blank">www.yuegege.com</a></p>
            <p class="address">现居：上海</p>
            <p class="role">职业：程序猿</p>
        </div>
        <h2><p>博客分类</p></h2>
        <ul class="news">
            <?php foreach($cat_list as $cv):?>
                <li><a href="/"><?php echo $cv['cat_name']?>(3)</a></li>
            <?php endforeach;?>
        ...
        <h2><p>文章归档</p></h2>
        <ul class="news">
            <li><a href="/">2016 年二月</a></li>
            <li><a href="/">2016 年三月</a></li>
            <li><a href="/">2016 年四月</a></li>
        </ul>
        <h2><p>友情链接</p></h2>
        <ul class="news">
...
<div id="copright">Design by <a href="http://www.yuegege.com" target="_blank">yuegege</a></div>
</body>
</html>