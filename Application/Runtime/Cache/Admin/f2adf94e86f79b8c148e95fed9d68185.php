...
<head>
    ...
    <!-- Morris -->
    <link href="/Public/default/admin/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">

    <link href="/Public/default/admin/css/animate.min.css" rel="stylesheet">
    <link href="/Public/default/admin/css/style.min.css?v=4.0.0" rel="stylesheet"><base target="_blank">
...
<body class="gray-bg sidebar-content">
        ...
        <div>
            ...
            <div class="feed-element">
                <a href="index_3.html#" class="pull-left">
                    <img alt="image" class="img-circle" src="/Public/default/admin/img/a1.jpg">
                </a>
            ...
            <div class="feed-element">
                <a href="index_3.html#" class="pull-left">
                    <img alt="image" class="img-circle" src="/Public/default/admin/img/a2.jpg">
                </a>
                <div class="media-body">
                    V信已经提前恢复，也算是个好消息吧
                    <br>
            ...
            <div class="feed-element">
                <a href="index_3.html#" class="pull-left">
                    <img alt="image" class="img-circle" src="/Public/default/admin/img/a3.jpg">
                </a>
                <div class="media-body">
                    是你对不对
                    <br>
            ...
            <div class="feed-element">
                <a href="index_3.html#" class="pull-left">
                    <img alt="image" class="img-circle" src="/Public/default/admin/img/a4.jpg">
                </a>
                <div class="media-body">
                    发布了一篇文章
                    <br>
    ...
    <script src="/Public/default/admin/js/plugins/flot/jquery.flot.js"></script>
    <script src="/Public/default/admin/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="/Public/default/admin/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="/Public/default/admin/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="/Public/default/admin/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="/Public/default/admin/js/plugins/flot/jquery.flot.symbol.js"></script>
    <script src="/Public/default/admin/js/plugins/flot/curvedLines.js"></script>
    <script src="/Public/default/admin/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="/Public/default/admin/js/demo/peity-demo.min.js"></script>
    <script src="/Public/default/admin/js/content.min.js?v=1.0.0"></script>
    <script src="/Public/default/admin/js/plugins/jquery-ui/jquery-ui.min.js"></script>
    <script src="/Public/default/admin/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="/Public/default/admin/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="/Public/default/admin/js/plugins/easypiechart/jquery.easypiechart.js"></script>
    <script src="/Public/default/admin/js/plugins/sparkline/jquery.sparkline.min.js"></script>
    <script src="/Public/default/admin/js/demo/sparkline-demo.min.js"></script>
    <script>
