            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <ul class="dropdown-menu dropdown-user">
                                <li><a href="/index.php/Admin/Authority/index">返回列表</a>
                                </li>
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="signupForm" method="post" action="/index.php/Admin/Authority/add">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control m-b" name="pid">
                                        <option>--顶级权限--</option>
										<?php foreach($auth_list as $v):?>
										<option value="<?php echo $v['authority_id']?>"><?php echo str_repeat('--',$v['deep']+1),$v['authority_name']?></option>
										<?php endforeach;?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input id="sort" name="sort" value="50" class="form-control" type="text" aria-required="true" aria-invalid="false" class="valid">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">状态：</label>
                                <div class="col-sm-4" style="padding-top:7px;">
                                    <input type="radio"  checked="" value="0" id="display" name="display" class="valid">正常
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio"  value="1" id="display" name="display" class="valid">停用
                                </div>
                            </div>
                            <div class="form-group">
